...
export function AppView({ ctx }: { ctx: AppViewContext }) {
  const {
    ...
    setNavigateToSection, setProtocolSelectHost, setQuickSearch, setSessionRenameValue, setTerminalFontFamilyId, setTerminalFontSize, setTerminalThemeId, updateSessionFontSize, updateSessionRestoreCwd, updateSessionDynamicTitle, clearSessionFontSizeOverride,
